...
// Search for the first key
        long firstKey = 1262127600000L; // Example: first key
        start = System.nanoTime();
        Double firstResult = cola.searchElement(firstKey);
        end = System.nanoTime();
        System.out.println("Search for first key: " + firstKey + " took " + (end - start) + " ns, result: " + firstResult);

// Search for the last key
        long lastKey = 1325458800000L; // Example: last key
        start = System.nanoTime();
        Double lastResult = cola.searchElement(lastKey);
        end = System.nanoTime();
        System.out.println("Search for last key: " + lastKey + " took " + (end - start) + " ns, result: " + lastResult);
